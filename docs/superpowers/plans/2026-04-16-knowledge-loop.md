...
- [x] **Step 3: Implement wiki list --json**
...
- [x] **Step 3: Add --embed flag option**
...
- [x] **Step 4: Implement --embed in update command**
...
- [x] **Step 6: Run full update test suite**
...
- [x] **Step 2: Verify skill file structure**
...
- [x] **Step 1: Update wiki create command documentation**
...
- [x] **Step 2: Add update --embed to CLI reference**

```
update [--pull] [--embed]    # --embed: 인덱스 갱신 후 임베딩 자동 실행
```

- [x] **Step 3: Add knowledge-post auto-save exception**
...
- [x] **Step 4: Add wiki collection setup guide**
...
- [x] **Step 2: Verify skill files are well-formed**
...
- [x] **Step 3: Manual smoke test — wiki list --json**
